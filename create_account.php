...
<body>
    ...
    if (isset($_POST['cadastrar'])) {
        ...
        if($key == "123"){
        $create = new Conection('user');
        $create->create_account($login, $pass);
        }
    }
    ...
    <div class="container text-white col-2 p-5 ">
        <form method="post" class="form-group">
            ...
            <br>
            <label for="key">Chave de Segurança</label>
            <input type="text" name='key' class="form-control">
            <br>
            <label for="vend">Vendedor</label>
            <input class="form-check-input" type="radio"name='cargo'value='vendedor'
            aria-label="Checkbox for following text input">
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <label for="esc">Escritório</label>
            <input class="form-check-input" type="radio"name='cargo'value='escritorio'
            aria-label="Checkbox for following text input">
            <br><br>
